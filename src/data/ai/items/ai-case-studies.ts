...
export const ai_case_studies: KnowledgeItem = {
  id: 'ai-case-studies',
  title: 'AI 产品拆解案例：Manus、Cursor、DeepSeek 与 Character.AI',
  category: 'ai',
  difficulty: 'hard',
  tags: ['Manus', 'Cursor', 'DeepSeek', 'Character.AI', '上下文工程', 'MoE', 'KV Cache'],
  content: `## AI 产品拆解案例：从 Manus、Cursor、DeepSeek 到 Character.AI
